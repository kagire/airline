...
class DepartmentRestControllerTest {
    ...
    @Test
    void newDepartmentShouldThrowBadRequest() throws Exception {
        when(departmentService.create(ArgumentMatchers.any())).thenReturn(0L);
    ...
    @Test
    void updateDepartmentShouldThrowBadRequest() throws Exception {
